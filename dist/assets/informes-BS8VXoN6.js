 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const I=globalThis,D=I.trustedTypes,X=D?D.createPolicy("lit-html",{createHTML:i=>i}):void 0,ct="$lit$",m=`lit$${Math.random().toFixed(9).slice(2)}$`,ht="?"+m,Ct=`<${ht}>`,A=document,S=()=>A.createComment(""),C=i=>i===null||typeof i!="object"&&typeof i!="function",pt=Array.isArray,Tt=i=>pt(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",L=`[ 	
\f\r]`,E=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,tt=/-->/g,et=/>/g,g=RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ot=/'/g,st=/"/g,ut=/^(?:script|style|textarea|title)$/i,Ut=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),$=Ut(1),x=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),it=new WeakMap,v=A.createTreeWalker(A,129);function bt(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return X!==void 0?X.createHTML(t):t}const Mt=(i,t)=>{const e=i.length-1,o=[];let s,n=t===2?"<svg>":"",r=E;for(let c=0;c<e;c++){const a=i[c];let h,d,l=-1,b=0;for(;b<a.length&&(r.lastIndex=b,d=r.exec(a),d!==null);)b=r.lastIndex,r===E?d[1]==="!--"?r=tt:d[1]!==void 0?r=et:d[2]!==void 0?(ut.test(d[2])&&(s=RegExp("</"+d[2],"g")),r=g):d[3]!==void 0&&(r=g):r===g?d[0]===">"?(r=s??E,l=-1):d[1]===void 0?l=-2:(l=r.lastIndex-d[2].length,h=d[1],r=d[3]===void 0?g:d[3]==='"'?st:ot):r===st||r===ot?r=g:r===tt||r===et?r=E:(r=g,s=void 0);const u=r===g&&i[c+1].startsWith("/>")?" ":"";n+=r===E?a+Ct:l>=0?(o.push(h),a.slice(0,l)+ct+a.slice(l)+m+u):a+m+(l===-2?c:u)}return[bt(i,n+(i[e]||"<?>")+(t===2?"</svg>":"")),o]};class T{constructor({strings:t,_$litType$:e},o){let s;this.parts=[];let n=0,r=0;const c=t.length-1,a=this.parts,[h,d]=Mt(t,e);if(this.el=T.createElement(h,o),v.currentNode=this.el.content,e===2){const l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(s=v.nextNode())!==null&&a.length<c;){if(s.nodeType===1){if(s.hasAttributes())for(const l of s.getAttributeNames())if(l.endsWith(ct)){const b=d[r++],u=s.getAttribute(l).split(m),M=/([.?@])?(.*)/.exec(b);a.push({type:1,index:n,name:M[2],strings:u,ctor:M[1]==="."?Dt:M[1]==="?"?Nt:M[1]==="@"?Ot:O}),s.removeAttribute(l)}else l.startsWith(m)&&(a.push({type:6,index:n}),s.removeAttribute(l));if(ut.test(s.tagName)){const l=s.textContent.split(m),b=l.length-1;if(b>0){s.textContent=D?D.emptyScript:"";for(let u=0;u<b;u++)s.append(l[u],S()),v.nextNode(),a.push({type:2,index:++n});s.append(l[b],S())}}}else if(s.nodeType===8)if(s.data===ht)a.push({type:2,index:n});else{let l=-1;for(;(l=s.data.indexOf(m,l+1))!==-1;)a.push({type:7,index:n}),l+=m.length-1}n++}}static createElement(t,e){const o=A.createElement("template");return o.innerHTML=t,o}}function _(i,t,e=i,o){var r,c;if(t===x)return t;let s=o!==void 0?(r=e._$Co)==null?void 0:r[o]:e._$Cl;const n=C(t)?void 0:t._$litDirective$;return(s==null?void 0:s.constructor)!==n&&((c=s==null?void 0:s._$AO)==null||c.call(s,!1),n===void 0?s=void 0:(s=new n(i),s._$AT(i,e,o)),o!==void 0?(e._$Co??(e._$Co=[]))[o]=s:e._$Cl=s),s!==void 0&&(t=_(i,s._$AS(i,t.values),s,o)),t}class Bt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:o}=this._$AD,s=((t==null?void 0:t.creationScope)??A).importNode(e,!0);v.currentNode=s;let n=v.nextNode(),r=0,c=0,a=o[0];for(;a!==void 0;){if(r===a.index){let h;a.type===2?h=new U(n,n.nextSibling,this,t):a.type===1?h=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(h=new Ht(n,this,t)),this._$AV.push(h),a=o[++c]}r!==(a==null?void 0:a.index)&&(n=v.nextNode(),r++)}return v.currentNode=A,s}p(t){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,e),e+=o.strings.length-2):o._$AI(t[e])),e++}}class U{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,o,s){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=o,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=_(this,t,e),C(t)?t===p||t==null||t===""?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==x&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Tt(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==p&&C(this._$AH)?this._$AA.nextSibling.data=t:this.T(A.createTextNode(t)),this._$AH=t}$(t){var n;const{values:e,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=T.createElement(bt(o.h,o.h[0]),this.options)),o);if(((n=this._$AH)==null?void 0:n._$AD)===s)this._$AH.p(e);else{const r=new Bt(s,this),c=r.u(this.options);r.p(e),this.T(c),this._$AH=r}}_$AC(t){let e=it.get(t.strings);return e===void 0&&it.set(t.strings,e=new T(t)),e}k(t){pt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,s=0;for(const n of t)s===e.length?e.push(o=new U(this.S(S()),this.S(S()),this,this.options)):o=e[s],o._$AI(n),s++;s<e.length&&(this._$AR(o&&o._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var o;for((o=this._$AP)==null?void 0:o.call(this,!1,!0,e);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class O{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,o,s,n){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=p}_$AI(t,e=this,o,s){const n=this.strings;let r=!1;if(n===void 0)t=_(this,t,e,0),r=!C(t)||t!==this._$AH&&t!==x,r&&(this._$AH=t);else{const c=t;let a,h;for(t=n[0],a=0;a<n.length-1;a++)h=_(this,c[o+a],e,a),h===x&&(h=this._$AH[a]),r||(r=!C(h)||h!==this._$AH[a]),h===p?t=p:t!==p&&(t+=(h??"")+n[a+1]),this._$AH[a]=h}r&&!s&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Dt extends O{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}}class Nt extends O{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==p)}}class Ot extends O{constructor(t,e,o,s,n){super(t,e,o,s,n),this.type=5}_$AI(t,e=this){if((t=_(this,t,e,0)??p)===x)return;const o=this._$AH,s=t===p&&o!==p||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,n=t!==p&&(o===p||s);s&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class Ht{constructor(t,e,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){_(this,t)}}const R=I.litHtmlPolyfillSupport;R==null||R(T,U),(I.litHtmlVersions??(I.litHtmlVersions=[])).push("3.1.3");const qt=(i,t,e)=>{const o=(e==null?void 0:e.renderBefore)??t;let s=o._$litPart$;if(s===void 0){const n=(e==null?void 0:e.renderBefore)??null;o._$litPart$=s=new U(t.insertBefore(S(),n),n,void 0,e??{})}return s._$AI(i),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class y extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=qt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return x}}var at;y._$litElement$=!0,y.finalized=!0,(at=globalThis.litElementHydrateSupport)==null||at.call(globalThis,{LitElement:y});const Z=globalThis.litElementPolyfillSupport;Z==null||Z({LitElement:y});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.0.5");async function H(i){try{const t=await fetch(i);if(!t.ok)throw new Error("Error al obtener los datos de la API");return await t.json()}catch(t){throw console.error("Error al obtener los datos:",t),t}}const j="https://665630689f970b3b36c49525.mockapi.io/materiaPrima";class mt extends y{constructor(){super(),this.datosAPI=[]}connectedCallback(){super.connectedCallback(),this.fetchDataFromAPI()}async fetchDataFromAPI(){try{this.datosAPI=await H(j),this.requestUpdate()}catch(t){console.error("Error al obtener los datos:",t)}}eliminarElemento(t){const e=[...this.datosAPI];this.datosAPI=this.datosAPI.filter(o=>o.id!==t),this.requestUpdate(),fetch(`${j}/${t}`,{method:"DELETE"}).then(o=>{if(!o.ok)throw new Error("No se pudo eliminar el elemento del mock API");this.requestUpdate()}).catch(o=>{console.error("Error al eliminar el elemento del mock API:",o),this.datosAPI=e,this.requestUpdate()})}editarElemento(t){const e=this.datosAPI.find(u=>u.id===t),o=prompt("Ingrese el nuevo nombre:",e.nombre);let s;for(;;)if(s=prompt("Ingrese la nueva fecha de adquisicion (YYYY-MM-DD):",e.fechaDeAdquisicion),s!==null&&!isNaN(Date.parse(s))){s=new Date(s).toISOString().split("T")[0];break}else alert("Por favor ingrese una fecha válida en formato YYYY-MM-DD.");let n;for(;;)if(n=prompt("Ingrese la nueva fecha de vencimiento (YYYY-MM-DD):",e.fechaDeVencimiento),n!==null&&!isNaN(Date.parse(n))){n=new Date(n).toISOString().split("T")[0];break}else alert("Por favor ingrese una fecha válida en formato YYYY-MM-DD.");let r;for(;;)if(r=prompt("Ingrese el nuevo costo por unidad:",e.costoUnidad),r!==null&&!isNaN(r)&&r.trim()!==""){r=parseFloat(r);break}else alert("Por favor ingrese un número válido para el costoUnidad.");const c=prompt("Ingrese el nuevo proveedor:",e.proveedor),a=prompt("Ingrese la nueva descripcion:",e.descripcion),h=prompt("Ingrese la nueva unidad de medida:",e.unidadMedida);let d;for(;;)if(d=prompt("Ingrese la nueva cantidad:",e.cantidad),d!==null&&!isNaN(d)&&d.trim()!==""){d=parseFloat(d);break}else alert("Por favor ingrese un número válido para el cantidad.");const l=prompt("Ingrese la nueva categoría:",e.categoria),b=prompt("Ingrese la nueva ubicacion:",e.ubicacion);o===null||s===null||(e.nombre=o,e.fechaDeAdquisicion=s,e.fechaDeVencimiento=n,e.costoUnidad=r,e.proveedor=c,e.descripcion=a,e.unidadMedida=h,e.cantidad=d,e.categoria=l,e.ubicacion=b,fetch(`${j}/${t}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(u=>{if(!u.ok)throw new Error("No se pudo actualizar el elemento en el mock API");this.fetchDataFromAPI()}).catch(u=>{console.error("Error al actualizar el elemento en el mock API:",u)}))}render(){return $`
